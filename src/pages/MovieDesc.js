            ...
            <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:px-0 lg:py-20 lg:max-w-none">
              <blockquote>
                ...
                <footer className="mt-6">
                  ...
                  <br />
                  <span className="px-2 py-1 text-green-800 text-md font-medium rounded-full">
                    &nbsp;
                  </span>
                  <br />
                  <span className="my-1 px-2 py-1 text-green-800 text-md font-medium bg-green-100 rounded-full">
                    Popularity: {movieData.vote_count}
                  </span>
                </footer>
              </blockquote>
            </div>
